...
public class LoginTest_PagePractise extends BaseTest {
	  ...
	  Logger log = LogManager.getLogger(LoginTest_PagePractise.class);
	    ...
	    public void openLoginPage_Practise() {
	        ...
	        loginPage_Practise = new LoginPage_Practise(driver, wait);
	    }
	    ...
	    public void loginSuccessfully() {
	        ...
	        // Koristi već postojeći `wait` iz BaseTest
		...
		public void usernameFieldIsDisplayed() {
			...
			loginPage_Practise.isUsernameInputDisplayed();
		...
		public void passwordFieldIsDisplayed() {
			log.info("Starting username field is on the page");
			loginPage_Practise.isPasswordInputDisplayed();
		...
		public void signButtonIsOnThePage() {
			...
			loginPage_Practise.isSignButtonDisplayed();
		...
		public void isAdminRadioButtonDisplayed() {
			...
			loginPage_Practise.isRadioAdminDisplayed();
		...
		public void isUserRadioButtonDisplayed() {
			...
			loginPage_Practise.isUserRadioDisplayed();
			
			Assert.assertTrue(loginPage_Practise.isRadioAdminDisplayed(), "User radio button is not displayed on the page");
		}	
		...
		public void isAgreeTermsOnPage() {
			log.info("Starting is isAgreeTermsOnPage");
			loginPage_Practise.isAgreeCheckboxDisplayed();
		...
		public void isAgreeTermsIsSelected()  {
			  log.info("Starting isAgreeTermsIsSelected");
			    ...
			    loginPage_Practise.clickAgreeCheckbox(); // akcija
			    Assert.assertTrue(loginPage_Practise.isAgreeCheckboxSelected(), "Agree checkbox is not selected"); // provera
			}
		
		@Test(priority = 14)
		public void testUserRadioSelection()  {
			log.info("Starting test UserRadioSelection");
